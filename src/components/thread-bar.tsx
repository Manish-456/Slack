...
export function ThreadBar({
  ...
  return (
    <button
      onClick={onClick}
      className="p-1 rounded-md hover:bg-gray-900 border border-transparent hover:border-border flex items-center justify-start group/thread-bar transition max-w-[600px]"
    >
