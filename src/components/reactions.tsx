...
export function Reactions({ data, onChange }: ReactionsProps) {
  ...
  return (
    <div className="flex items-center flex-wrap gap-1 mt-1 mb-1">
      {data.map((reaction) => (
        ...
        >
          <button
            ...
            className={cn(
              "h-6 rounded-full bg-slate-200/70 px-2 border border-transparent text-slate-800 flex items-center gap-x-1",
      ...
      >
        <button className="h-7 px-3 rounded-full bg-slate-200/70 border border-transparent hover:border-slate-500 flex text-slate-800 items-center gap-x-1">
